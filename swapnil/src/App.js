    ...
    <div className="fade-up">
      <Section style={{ paddingTop: 60 }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1.2fr 1fr", gap: 48, alignItems: "start", marginBottom: 64 }}>
          <div>
            <h2 style={{ fontFamily: "Space Grotesk, sans-serif", fontSize: 32, fontWeight: 700, letterSpacing: "-0.02em", marginBottom: 20 }}>
              Engineering Systems with<br /><span style={{ color: "var(--accent-color)" }}>Cognitive Intelligence</span>
            </h2>
            <p style={{ color: "var(--text-muted)", lineHeight: 1.8, fontSize: 15, marginBottom: 16 }}>
              I'm a Computer Science graduate from SOA University, Bhubaneswar, specializing in Artificial Intelligence, Machine Learning, and Generative AI frameworks.
            </p>
            <p style={{ color: "var(--text-muted)", lineHeight: 1.8, fontSize: 15, marginBottom: 16 }}>
